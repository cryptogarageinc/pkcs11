...
func (m *MockPkcs11) DeriveKeyPairWithBIP32(ctx context.Context, session pkcs11.SessionHandle, masterXprivHandle pkcs11.ObjectHandle, path []uint32, skLabel string) (pkcs11.ObjectHandle, pkcs11.ObjectHandle, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeriveKeyPairWithBIP32", ctx, session, masterXprivHandle, path, skLabel)
	ret0, _ := ret[0].(pkcs11.ObjectHandle)
	ret1, _ := ret[1].(pkcs11.ObjectHandle)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockPkcs11MockRecorder) DeriveKeyPairWithBIP32(ctx, session, masterXprivHandle, path, skLabel any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeriveKeyPairWithBIP32", reflect.TypeOf((*MockPkcs11)(nil).DeriveKeyPairWithBIP32), ctx, session, masterXprivHandle, path, skLabel)
}
